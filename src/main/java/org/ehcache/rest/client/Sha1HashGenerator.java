...
class Sha1HashGenerator implements HashGenerator {

	/**
	 * Logger for the class.
	 */
	private static final Logger log = LoggerFactory.getLogger(Sha1HashGenerator.class);
	 ...
	 * @param byteArrays
	 */
	public Sha1HashGenerator(ByteArrays byteArrays) {
